...
object WayGL {
    ...
    private fun applyNvidiaWorkaround(os: OS, adapters: List<LinuxAdapterInfo>): Boolean {
        return os == OS.LINUX && adapters.any { it.vendor == GraphicsAdapterVendor.NVIDIA } && !(PlatformServiceImpl.isModLoaded("sodium") || PlatformServiceImpl.isModLoaded("embeddium"))
    }
